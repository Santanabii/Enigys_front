        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-wrap gap-4 mt-10">
            <button 
              ...
              className="px-8 py-4 bg-[#10B981] hover:bg-[#059669] text-white font-semibold rounded-full transition-all transform hover:scale-105 shadow-lg hover:shadow-[#10B981]/30 cursor-pointer"
            >
              Get Started
            </button>
            <button 
              onClick={handleLearnMore}
              className="px-8 py-4 border-2 border-white/30 hover:border-white text-white font-semibold rounded-full transition-all hover:bg-white/10 backdrop-blur-sm cursor-pointer"
            >
              Learn More →
            </button>
          </div>
          ...
          <div className="lg:col-span-7 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-100 hover:border-[#2563EB] transition-all group">
              ...
              <button 
                ...
                className="mt-6 text-[#2563EB] font-medium hover:text-[#1D4ED8] transition-all group-hover:translate-x-2 inline-block cursor-pointer"
              >
                View Services →
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-[#F3F7FA] p-8 rounded-3xl">
              ...
              <ul className="space-y-4 text-[#475569]">
                ...
                <li className="flex gap-3"><span className="text-[#10B981] font-bold">•</span> Building Management &amp; Automation Systems</li>
      ...
      <section className="bg-[#0A192F] py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button 
              onClick={handleViewProjects}
              className="px-8 py-4 border-2 border-white/30 hover:border-white text-white font-semibold rounded-full transition-all hover:bg-white/10 cursor-pointer"
            >
              View Our Projects
            </button>
          </div>
